<%-- 
    Document   : login
    Created on : Nov 21, 2018, 9:23:11 PM
    Author     : campitos
--%>
...
<head>
    ...
    <title>Proyecto de Base de Datos II</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="http://localhost:8084/bd2/autenticar.php" method="post">
                            <fieldset>
